tag @s add bow.crossbow.offhand_charging
...
execute if entity @s[scores={bow.crossbow.aiming=135..145}] unless data storage bow_attributes:player offhand{tag:{crit:1b}} unless data storage bow_attributes:player offhand{tag:{ChargedProjectiles:[{}]}} run function bow_attributes:crossbow/crit_offhand